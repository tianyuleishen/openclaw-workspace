...
class FixedAStockSimulator extends AStockSimulator {
   ...
   * 运行修复版模拟交易
   */
  runFixedSimulation(symbols = ['000001.SZ', '600000.SH', '000858.SZ', '002594.SZ', '600519.SH'], days = 60) {
    console.log(`\n🚀 运行修复版A股AI策略模拟交易`);
...
if (require.main === module) {
  console.log("🎯 修复版A股AI策略模拟交易系统");
  console.log("=" .repeat(60));
  
  const simulator = new FixedAStockSimulator(100000); // 10万初始资金
  
  // 运行修复版模拟交易
  const symbols = ['000001.SZ', '600000.SH', '000858.SZ', '002594.SZ', '600519.SH'];
  const report = simulator.runFixedSimulation(symbols, 30); // 30个交易日以加快演示
...
module.exports = FixedAStockSimulator;