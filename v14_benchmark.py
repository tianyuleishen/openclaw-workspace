...
from reasoning_engine_v14 import ReasoningEngineV14


def run_benchmark():
    print("="*70)
    print("🦄 v14.0 终极版 benchmark")
    print("="*70)
    ...
    test_cases = [
        ...
        ("运行这段Python代码: print('Hello')", "code_execution", ["运行"]),
        ("搜索最新AI新闻2025", "web_search", ["2025"]),
    ...
    for i, (question, expected_type, keywords) in enumerate(test_cases, 1):
        ...
        print(f"{i:2d}. {result.get('type', 'general'):18s} {status}{tool_mark} | {question[:35]:35s}")
